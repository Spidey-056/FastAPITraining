...
# Pydantic models also shape the outgoing response
...
class UserCreate(BaseModel):
    ...
    role: UserRole = Field(default=UserRole.CUSTOMER, description="One of: customer, support_agent, support_team_lead, admin")
